...
"}")
        ...
        self.etToFolder.setStyleSheet(u"QLineEdit {\n"
"    border: none;\n"
"}")
        ...
        self.btnSelectToFolder.setGeometry(QRect(870, 17, 151, 31))
        self.btnSelectToFolder.setStyleSheet(u"QPushButton {\n"
"    background-color: rgb(255, 255, 255);\n"
...
"")
        ...
        self.scrollArea_2.setGeometry(QRect(20, 100, 1021, 391))

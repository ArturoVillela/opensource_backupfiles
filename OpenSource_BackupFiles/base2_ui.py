...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnAddFilesToSave.setGeometry(QRect(30, 50, 291, 28))
        self.btnSelectToFolder = QPushButton(self.centralwidget)
        self.btnSelectToFolder.setObjectName(u"btnSelectToFolder")
        self.btnSelectToFolder.setGeometry(QRect(30, 510, 291, 28))
        self.rdbtnSameStructure = QRadioButton(self.centralwidget)
        self.rdbtnSameStructure.setObjectName(u"rdbtnSameStructure")
        self.rdbtnSameStructure.setGeometry(QRect(30, 480, 161, 25))
        self.frame = QFrame(self.centralwidget)
        self.frame.setObjectName(u"frame")
        self.frame.setEnabled(False)
        self.frame.setGeometry(QRect(380, 40, 661, 581))
        ...
        self.etToFolder.setGeometry(QRect(30, 550, 291, 28))
        ...
        self.btnStartStop.setGeometry(QRect(30, 600, 291, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnAddFilesToSave.setText(QCoreApplication.translate("MainWindow", u"Add files & folders to save", None))
        self.btnSelectToFolder.setText(QCoreApplication.translate("MainWindow", u"Select To Folder", None))
        self.rdbtnSameStructure.setText(QCoreApplication.translate("MainWindow", u"Same Structure", None))
